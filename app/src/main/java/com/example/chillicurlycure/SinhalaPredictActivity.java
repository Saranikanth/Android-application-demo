...
public class SinhalaPredictActivity extends AppCompatActivity {
    ...
    ImageView imageView;
    Uri imageuri;
    private ImageButton buclassify;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sinhala_predict);

        //Select Button assign
        select_button=(ImageButton) findViewById(R.id.select_btn_sinhala);
        imageView = (ImageView) findViewById(R.id.photo);
        buclassify=(ImageButton)findViewById(R.id.classify_btn_sinhala);
        ...
        try{
            tflite=new Interpreter(loadmodelfile(SinhalaPredictActivity.this));
        }catch (Exception e) {
            e.printStackTrace();
        }
...
//To set components of x axis
    ...
    private void showresult(){
        ...
        try{
            labels = FileUtil.loadLabels(SinhalaPredictActivity.this,"label3.txt");
        }catch (Exception e){
            e.printStackTrace();
        }
