...
public class TamilPredictActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tamil_predict);

        //Select Button assign
        select_button=(ImageButton) findViewById(R.id.select_btn_tamil);
        imageView = (ImageView) findViewById(R.id.photo);
        buclassify=(ImageButton)findViewById(R.id.classify_btn_tamil);
        ...
        try{
            tflite=new Interpreter(loadmodelfile(TamilPredictActivity.this));
        }catch (Exception e) {
            e.printStackTrace();
        }
...
//To set components of x axis
    ...
    private void showresult(){
        ...
        try{
            labels = FileUtil.loadLabels(TamilPredictActivity.this,"label2.txt");
        }catch (Exception e){
            e.printStackTrace();
        }
